...
<body>
   <a href="index.php?controlador=animal&accion=mostrarAnimal">Nuevo</a>    
    ...
    <tr>
        ...
        <td><a href="index.php?controlador=animal&accion=eliminarAnimal&&id=<?php echo $animal->id?>" onclick="javascript:return confirm('¿Seguro de eliminar este registro?')" >Eliminar</a></td>
    </tr>
    <?php endforeach; ?>    
    </table>
